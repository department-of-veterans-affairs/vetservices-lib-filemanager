...
//	FileManagerProperties fileManagerProperties;
	...
	public final void testValidate() {
		...
		assertNotNull(messages);
		assertTrue(messages.size() > 0);
		assertTrue(messages.get(0).getKey().equals(LibFileManagerMessageKeys.FILE_DTO_NULL));
		...
		assertNotNull(messages);
		assertTrue(messages.size() > 0);
		assertTrue(messages.get(0).getKey().equals(LibFileManagerMessageKeys.FILE_NAME_MALFORMED));
	}
